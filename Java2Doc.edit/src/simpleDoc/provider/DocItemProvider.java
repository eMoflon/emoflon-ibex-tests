...
/**
 * This is the item provider adapter for a {@link simpleDoc.Doc} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DocItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Doc_name_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Doc_name_feature", "_UI_Doc_type"),
						SimpleDocPackage.Literals.DOC__NAME, true, false, false,
	...
	protected void addContentPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Doc_content_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Doc_content_feature", "_UI_Doc_type"),
						SimpleDocPackage.Literals.DOC__CONTENT, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	public String getText(Object object) {
		String label = ((Doc) object).getName();
	...
	public void notifyChanged(Notification notification) {
		...
		case SimpleDocPackage.DOC__NAME:
