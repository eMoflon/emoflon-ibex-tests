...
/**
 * This is the item provider adapter for a {@link simpleDoc.Folder} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class FolderItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						SimpleDocPackage.Literals.FOLDER__NAME, true, false, false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(SimpleDocPackage.Literals.FOLDER__SUB_FOLDERS);
			childrenFeatures.add(SimpleDocPackage.Literals.FOLDER__DOCS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(SimpleDocPackage.Literals.FOLDER__SUB_FOLDERS,
				SimpleDocFactory.eINSTANCE.createFolder()));

		newChildDescriptors.add(
				createChildParameter(SimpleDocPackage.Literals.FOLDER__DOCS, SimpleDocFactory.eINSTANCE.createDoc()));
	}
