...
public class ViatraRegistrationHelper implements IRegistrationHelper {
	...
	public void registerMetamodels(ResourceSet rs, IbexExecutable executable) throws IOException {
		...
		executable.getResourceHandler().loadAndRegisterMetamodel("platform:/resource/CompanyLanguage/model/CompanyLanguage.ecore");
		executable.getResourceHandler().loadAndRegisterMetamodel("platform:/resource/ITLanguage/model/ITLanguage.ecore");
	}
