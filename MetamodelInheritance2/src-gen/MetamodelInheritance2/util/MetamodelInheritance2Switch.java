 ...
 * @generated
 */
public class MetamodelInheritance2Switch<T> extends Switch<T> {
	/**
	 ...
	 * @generated
	 */
	public MetamodelInheritance2Switch() {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case MetamodelInheritance2Package.CHILD_A: {
			...
			if (result == null)
				result = caseBaseContaineeA(childA);
			if (result == null)
		...
		case MetamodelInheritance2Package.CHILD_B: {
			...
			if (result == null)
				result = caseBaseContaineeB(childB);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case MetamodelInheritance2Package.CHILD_CONTAINEE_D: {
			ChildContaineeD childContaineeD = (ChildContaineeD) theEObject;
			T result = caseChildContaineeD(childContaineeD);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Child A</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Child A</em>'.
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Child B</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Child B</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
