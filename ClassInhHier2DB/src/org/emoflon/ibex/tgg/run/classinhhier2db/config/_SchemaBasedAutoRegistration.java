...
public class _SchemaBasedAutoRegistration {
	...
	public static void register(OperationalStrategy strategy) throws IOException {
		strategy.loadAndRegisterMetamodel("platform:/resource/ClassInheritanceHierarchy/model/ClassInheritanceHierarchy.ecore");
		strategy.loadAndRegisterMetamodel("platform:/resource/Database/model/Database.ecore");
	}
