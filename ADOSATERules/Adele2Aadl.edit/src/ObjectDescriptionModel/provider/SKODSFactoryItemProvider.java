...
import ObjectDescriptionModel.SKODSFactory;
...
/**
 * This is the item provider adapter for a {@link ObjectDescriptionModel.SKODSFactory} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SKODSFactoryItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addDomODSPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_SKODSFactory_domODS_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_SKODSFactory_domODS_feature",
								"_UI_SKODSFactory_type"),
						ObjectDescriptionModelPackage.Literals.SKODS_FACTORY__DOM_ODS, false, false, false,
	...
	protected void addCurrentODSDatafileNodePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_SKODSFactory_currentODSDatafileNode_feature"),
						getString("_UI_PropertyDescriptor_description",
								"_UI_SKODSFactory_currentODSDatafileNode_feature", "_UI_SKODSFactory_type"),
						ObjectDescriptionModelPackage.Literals.SKODS_FACTORY__CURRENT_ODS_DATAFILE_NODE, false, false,
	...
	protected void addDomDataPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description", "_UI_SKODSFactory_domData_feature",
						"_UI_SKODSFactory_type"),
				ObjectDescriptionModelPackage.Literals.SKODS_FACTORY__DOM_DATA, false, false, false,
				ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	protected void addCurrentObjectPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description", "_UI_SKODSFactory_currentObject_feature",
						"_UI_SKODSFactory_type"),
				ObjectDescriptionModelPackage.Literals.SKODS_FACTORY__CURRENT_OBJECT, false, false, false, null, null,
				null));
	}
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ? getString("_UI_SKODSFactory_type")
