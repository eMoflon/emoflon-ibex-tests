...
import KernelSpices.SKHierarchicalObject;
...
/**
 * This is the item provider adapter for a {@link KernelSpices.SKHierarchicalObject} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SKHierarchicalObjectItemProvider extends SKObjectItemProvider {
	/**
	...
	protected void addLevelPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description", "_UI_SKHierarchicalObject_level_feature",
						"_UI_SKHierarchicalObject_type"),
				KernelSpicesPackage.Literals.SK_HIERARCHICAL_OBJECT__LEVEL, false, false, false,
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ? getString("_UI_SKHierarchicalObject_type")
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(KernelSpicesPackage.Literals.SK_HIERARCHICAL_OBJECT__PROPERTIES,
				KernelSpicesFactory.eINSTANCE.createSKProperty()));

		newChildDescriptors.add(createChildParameter(KernelSpicesPackage.Literals.SK_HIERARCHICAL_OBJECT__CHILDREN,
		...
		newChildDescriptors.add(createChildParameter(KernelSpicesPackage.Literals.SK_HIERARCHICAL_OBJECT__OD_SYSTEMS,
