...
/**
 * This is the item provider adapter for a {@link ADELE_Components.ThreadGroup} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ThreadGroupItemProvider extends ComponentItemProvider {
	/**
	...
	public String getText(Object object) {
		String label = ((ADELE_Components.ThreadGroup) object).getName();
		return label == null || label.length() == 0 ? getString("_UI_ThreadGroup_type")
