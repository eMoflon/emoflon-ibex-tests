...
import ADELE_Features.FeatureGroup;
...
/**
 * This is the item provider adapter for a {@link ADELE_Features.FeatureGroup} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class FeatureGroupItemProvider extends DirectedFeatureItemProvider {
	...
	protected void addAuthorizedSubcomponentsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description", "_UI_SKComponent_authorizedSubcomponents_feature",
						"_UI_SKComponent_type"),
				KernelSpicesPackage.Literals.SK_COMPONENT__AUTHORIZED_SUBCOMPONENTS, true, false, false,
	...
	protected void addAuthorizedFeaturesPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_SKComponent_authorizedFeatures_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_SKComponent_authorizedFeatures_feature",
								"_UI_SKComponent_type"),
						KernelSpicesPackage.Literals.SK_COMPONENT__AUTHORIZED_FEATURES, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	protected void addInverseFeaturePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_FeatureGroup_inverseFeature_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_FeatureGroup_inverseFeature_feature",
								"_UI_FeatureGroup_type"),
						ADELE_FeaturesPackage.Literals.FEATURE_GROUP__INVERSE_FEATURE, true, false, true, null, null,
						null));
	}
	...
	protected void addTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_FeatureGroup_type_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_FeatureGroup_type_feature",
								"_UI_FeatureGroup_type"),
						ADELE_FeaturesPackage.Literals.FEATURE_GROUP__TYPE, false, false, false,
	...
	protected void addAllRealFeaturesPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description", "_UI_FeatureGroup_allRealFeatures_feature",
						"_UI_FeatureGroup_type"),
				ADELE_FeaturesPackage.Literals.FEATURE_GROUP__ALL_REAL_FEATURES, false, false, false, null, null,
				null));
	}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(KernelSpicesPackage.Literals.SK_COMPONENT__FEATURES,
