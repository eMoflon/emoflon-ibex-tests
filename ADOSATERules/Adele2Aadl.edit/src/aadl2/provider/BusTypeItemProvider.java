...
public class BusTypeItemProvider extends ComponentTypeItemProvider {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(Aadl2Package.Literals.BUS_TYPE__OWNED_BUS_ACCESS);
			childrenFeatures.add(Aadl2Package.Literals.BUS_TYPE__OWNED_DATA_PORT);
			childrenFeatures.add(Aadl2Package.Literals.BUS_TYPE__OWNED_EVENT_DATA_PORT);
			childrenFeatures.add(Aadl2Package.Literals.BUS_TYPE__OWNED_EVENT_PORT);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(Aadl2Package.Literals.BUS_TYPE__OWNED_BUS_ACCESS,
				Aadl2Factory.eINSTANCE.createBusAccess()));

		newChildDescriptors.add(createChildParameter(Aadl2Package.Literals.BUS_TYPE__OWNED_DATA_PORT,
				Aadl2Factory.eINSTANCE.createDataPort()));

		newChildDescriptors.add(createChildParameter(Aadl2Package.Literals.BUS_TYPE__OWNED_EVENT_DATA_PORT,
				Aadl2Factory.eINSTANCE.createEventDataPort()));

		newChildDescriptors.add(createChildParameter(Aadl2Package.Literals.BUS_TYPE__OWNED_EVENT_PORT,
