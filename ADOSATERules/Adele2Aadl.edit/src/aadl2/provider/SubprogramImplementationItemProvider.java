...
public class SubprogramImplementationItemProvider extends BehavioredImplementationItemProvider {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(Aadl2Package.Literals.SUBPROGRAM_IMPLEMENTATION__OWNED_DATA_SUBCOMPONENT);
			childrenFeatures.add(Aadl2Package.Literals.SUBPROGRAM_IMPLEMENTATION__OWNED_SUBPROGRAM_SUBCOMPONENT);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors
				.add(createChildParameter(Aadl2Package.Literals.SUBPROGRAM_IMPLEMENTATION__OWNED_DATA_SUBCOMPONENT,
						Aadl2Factory.eINSTANCE.createDataSubcomponent()));

		newChildDescriptors.add(
				createChildParameter(Aadl2Package.Literals.SUBPROGRAM_IMPLEMENTATION__OWNED_SUBPROGRAM_SUBCOMPONENT,
