...
public class FlowSpecificationItemProvider extends FlowFeatureItemProvider {
	...
	protected void addRefinedPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						Aadl2Package.Literals.FLOW_SPECIFICATION__REFINED, true, false, true, null, null, null));
	}
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_FlowSpecification_kind_feature",
								"_UI_FlowSpecification_type"),
						Aadl2Package.Literals.FLOW_SPECIFICATION__KIND, true, false, false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(Aadl2Package.Literals.FLOW_SPECIFICATION__OUT_END);
			childrenFeatures.add(Aadl2Package.Literals.FLOW_SPECIFICATION__IN_END);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(Aadl2Package.Literals.FLOW_SPECIFICATION__OUT_END,
				Aadl2Factory.eINSTANCE.createFlowEnd()));

		newChildDescriptors.add(createChildParameter(Aadl2Package.Literals.FLOW_SPECIFICATION__IN_END,
				Aadl2Factory.eINSTANCE.createFlowEnd()));
	}
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify = childFeature == Aadl2Package.Literals.FLOW_SPECIFICATION__OUT_END
				|| childFeature == Aadl2Package.Literals.FLOW_SPECIFICATION__IN_END;
