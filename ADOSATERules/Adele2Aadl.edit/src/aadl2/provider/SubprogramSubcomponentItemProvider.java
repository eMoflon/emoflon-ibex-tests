...
public class SubprogramSubcomponentItemProvider extends SubcomponentItemProvider {
	...
	protected void addSubprogramSubcomponentTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				Aadl2Package.Literals.SUBPROGRAM_SUBCOMPONENT__SUBPROGRAM_SUBCOMPONENT_TYPE, true, false, true, null,
				null, null));
	}
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ? getString("_UI_SubprogramSubcomponent_type")
