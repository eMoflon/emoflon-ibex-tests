...
public class SubprogramGroupImplementationItemProvider extends ComponentImplementationItemProvider {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(Aadl2Package.Literals.SUBPROGRAM_GROUP_IMPLEMENTATION__OWNED_SUBPROGRAM_SUBCOMPONENT);
			childrenFeatures
					.add(Aadl2Package.Literals.SUBPROGRAM_GROUP_IMPLEMENTATION__OWNED_SUBPROGRAM_GROUP_SUBCOMPONENT);
			childrenFeatures.add(Aadl2Package.Literals.SUBPROGRAM_GROUP_IMPLEMENTATION__OWNED_DATA_SUBCOMPONENT);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(
				Aadl2Package.Literals.SUBPROGRAM_GROUP_IMPLEMENTATION__OWNED_SUBPROGRAM_SUBCOMPONENT,
				Aadl2Factory.eINSTANCE.createSubprogramSubcomponent()));

		newChildDescriptors.add(createChildParameter(
				Aadl2Package.Literals.SUBPROGRAM_GROUP_IMPLEMENTATION__OWNED_SUBPROGRAM_GROUP_SUBCOMPONENT,
				Aadl2Factory.eINSTANCE.createSubprogramGroupSubcomponent()));

		newChildDescriptors.add(
				createChildParameter(Aadl2Package.Literals.SUBPROGRAM_GROUP_IMPLEMENTATION__OWNED_DATA_SUBCOMPONENT,
