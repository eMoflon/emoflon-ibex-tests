...
public class PropertyAssociationItemProvider extends ElementItemProvider {
	...
	protected void addPropertyPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						Aadl2Package.Literals.PROPERTY_ASSOCIATION__PROPERTY, true, false, true, null, null, null));
	}
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_PropertyAssociation_inBinding_feature",
								"_UI_PropertyAssociation_type"),
						Aadl2Package.Literals.PROPERTY_ASSOCIATION__IN_BINDING, true, false, true, null, null, null));
	}
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_PropertyAssociation_append_feature",
								"_UI_PropertyAssociation_type"),
						Aadl2Package.Literals.PROPERTY_ASSOCIATION__APPEND, true, false, false,
	...
	protected void addConstantPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_PropertyAssociation_constant_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_PropertyAssociation_constant_feature",
								"_UI_PropertyAssociation_type"),
						Aadl2Package.Literals.PROPERTY_ASSOCIATION__CONSTANT, true, false, false,
						ItemPropertyDescriptor.BOOLEAN_VALUE_IMAGE, null, null));
	}
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(Aadl2Package.Literals.PROPERTY_ASSOCIATION__APPLIES_TO);
			childrenFeatures.add(Aadl2Package.Literals.PROPERTY_ASSOCIATION__OWNED_VALUE);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(Aadl2Package.Literals.PROPERTY_ASSOCIATION__APPLIES_TO,
				Aadl2Factory.eINSTANCE.createContainedNamedElement()));

		newChildDescriptors.add(createChildParameter(Aadl2Package.Literals.PROPERTY_ASSOCIATION__APPLIES_TO,
				Aadl2Factory.eINSTANCE.createReferenceValue()));

		newChildDescriptors.add(createChildParameter(Aadl2Package.Literals.PROPERTY_ASSOCIATION__OWNED_VALUE,
