...
public class ComponentPrototypeActualItemProvider extends ArrayableElementItemProvider {
	...
	protected void addCategoryPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						Aadl2Package.Literals.COMPONENT_PROTOTYPE_ACTUAL__CATEGORY, true, false, false,
	...
	protected void addSubcomponentTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description", "_UI_ComponentPrototypeActual_subcomponentType_feature",
						"_UI_ComponentPrototypeActual_type"),
				Aadl2Package.Literals.COMPONENT_PROTOTYPE_ACTUAL__SUBCOMPONENT_TYPE, true, false, true, null, null,
				null));
	}
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(Aadl2Package.Literals.COMPONENT_PROTOTYPE_ACTUAL__BINDING);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(Aadl2Package.Literals.COMPONENT_PROTOTYPE_ACTUAL__BINDING,
