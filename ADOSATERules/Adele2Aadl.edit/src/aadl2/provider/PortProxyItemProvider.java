		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_PortProxy_direction_feature",
								"_UI_PortProxy_type"),
						Aadl2Package.Literals.PORT_PROXY__DIRECTION, false, false, false,
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_PortProxy_dataClassifier_feature",
								"_UI_PortProxy_type"),
						Aadl2Package.Literals.PORT_PROXY__DATA_CLASSIFIER, true, false, true, null, null, null));
	}
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_PortProxy_in_feature",
								"_UI_PortProxy_type"),
						Aadl2Package.Literals.PORT_PROXY__IN, true, false, false,
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_PortProxy_out_feature",
								"_UI_PortProxy_type"),
						Aadl2Package.Literals.PORT_PROXY__OUT, true, false, false,
						ItemPropertyDescriptor.BOOLEAN_VALUE_IMAGE, null, null));
	}
