...
public class NumberTypeItemProvider extends NonListTypeItemProvider {
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_NumberType_referencedUnitsType_feature",
								"_UI_NumberType_type"),
						Aadl2Package.Literals.NUMBER_TYPE__REFERENCED_UNITS_TYPE, true, false, true, null, null, null));
	}
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_NumberType_unitsType_feature",
								"_UI_NumberType_type"),
						Aadl2Package.Literals.NUMBER_TYPE__UNITS_TYPE, false, false, false, null, null, null));
	}
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(Aadl2Package.Literals.NUMBER_TYPE__OWNED_UNITS_TYPE);
			childrenFeatures.add(Aadl2Package.Literals.NUMBER_TYPE__RANGE);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(Aadl2Package.Literals.NUMBER_TYPE__OWNED_UNITS_TYPE,
				Aadl2Factory.eINSTANCE.createUnitsType()));

		newChildDescriptors.add(createChildParameter(Aadl2Package.Literals.NUMBER_TYPE__RANGE,
