...
public class NumericRangeItemProvider extends ElementItemProvider {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(Aadl2Package.Literals.NUMERIC_RANGE__UPPER_BOUND);
			childrenFeatures.add(Aadl2Package.Literals.NUMERIC_RANGE__LOWER_BOUND);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(Aadl2Package.Literals.NUMERIC_RANGE__UPPER_BOUND,
		...
		newChildDescriptors.add(createChildParameter(Aadl2Package.Literals.NUMERIC_RANGE__LOWER_BOUND,
				Aadl2Factory.eINSTANCE.createStringLiteral()));
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify = childFeature == Aadl2Package.Literals.NUMERIC_RANGE__UPPER_BOUND
				|| childFeature == Aadl2Package.Literals.NUMERIC_RANGE__LOWER_BOUND;
