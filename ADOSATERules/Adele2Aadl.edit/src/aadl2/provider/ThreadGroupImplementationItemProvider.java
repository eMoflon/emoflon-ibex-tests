...
public class ThreadGroupImplementationItemProvider extends ComponentImplementationItemProvider {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(Aadl2Package.Literals.THREAD_GROUP_IMPLEMENTATION__OWNED_DATA_SUBCOMPONENT);
			childrenFeatures.add(Aadl2Package.Literals.THREAD_GROUP_IMPLEMENTATION__OWNED_THREAD_SUBCOMPONENT);
			childrenFeatures.add(Aadl2Package.Literals.THREAD_GROUP_IMPLEMENTATION__OWNED_THREAD_GROUP_SUBCOMPONENT);
			childrenFeatures.add(Aadl2Package.Literals.THREAD_GROUP_IMPLEMENTATION__OWNED_SUBPROGRAM_SUBCOMPONENT);
			childrenFeatures
					.add(Aadl2Package.Literals.THREAD_GROUP_IMPLEMENTATION__OWNED_SUBPROGRAM_GROUP_SUBCOMPONENT);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors
				.add(createChildParameter(Aadl2Package.Literals.THREAD_GROUP_IMPLEMENTATION__OWNED_DATA_SUBCOMPONENT,
						Aadl2Factory.eINSTANCE.createDataSubcomponent()));

		newChildDescriptors
				.add(createChildParameter(Aadl2Package.Literals.THREAD_GROUP_IMPLEMENTATION__OWNED_THREAD_SUBCOMPONENT,
						Aadl2Factory.eINSTANCE.createThreadSubcomponent()));

		newChildDescriptors.add(
				createChildParameter(Aadl2Package.Literals.THREAD_GROUP_IMPLEMENTATION__OWNED_THREAD_GROUP_SUBCOMPONENT,
						Aadl2Factory.eINSTANCE.createThreadGroupSubcomponent()));

		newChildDescriptors.add(
				createChildParameter(Aadl2Package.Literals.THREAD_GROUP_IMPLEMENTATION__OWNED_SUBPROGRAM_SUBCOMPONENT,
						Aadl2Factory.eINSTANCE.createSubprogramSubcomponent()));

		newChildDescriptors.add(createChildParameter(
				Aadl2Package.Literals.THREAD_GROUP_IMPLEMENTATION__OWNED_SUBPROGRAM_GROUP_SUBCOMPONENT,
