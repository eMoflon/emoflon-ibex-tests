...
public class DataSubcomponentItemProvider extends SubcomponentItemProvider {
	...
	protected void addDataSubcomponentTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				Aadl2Package.Literals.DATA_SUBCOMPONENT__DATA_SUBCOMPONENT_TYPE, true, false, true, null, null, null));
	}
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ? getString("_UI_DataSubcomponent_type")
