	...
	protected void addDirectionPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						Aadl2Package.Literals.INTERNAL_FEATURE__DIRECTION, false, false, false,
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_InternalFeature_in_feature",
								"_UI_InternalFeature_type"),
						Aadl2Package.Literals.INTERNAL_FEATURE__IN, true, false, false,
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_InternalFeature_out_feature",
								"_UI_InternalFeature_type"),
						Aadl2Package.Literals.INTERNAL_FEATURE__OUT, true, false, false,
						ItemPropertyDescriptor.BOOLEAN_VALUE_IMAGE, null, null));
	}
