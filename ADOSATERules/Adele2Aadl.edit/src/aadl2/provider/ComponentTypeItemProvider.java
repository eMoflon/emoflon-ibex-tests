...
public class ComponentTypeItemProvider extends ComponentClassifierItemProvider {
	...
	protected void addOwnedFeaturePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						Aadl2Package.Literals.COMPONENT_TYPE__OWNED_FEATURE, false, false, false, null, null, null));
	}
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_ComponentType_extended_feature",
								"_UI_ComponentType_type"),
						Aadl2Package.Literals.COMPONENT_TYPE__EXTENDED, true, false, true, null, null, null));
	}
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_ComponentType_noFeatures_feature",
								"_UI_ComponentType_type"),
						Aadl2Package.Literals.COMPONENT_TYPE__NO_FEATURES, true, false, false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(Aadl2Package.Literals.COMPONENT_TYPE__OWNED_FLOW_SPECIFICATION);
			childrenFeatures.add(Aadl2Package.Literals.COMPONENT_TYPE__OWNED_EXTENSION);
			childrenFeatures.add(Aadl2Package.Literals.COMPONENT_TYPE__OWNED_FEATURE_GROUP);
			childrenFeatures.add(Aadl2Package.Literals.COMPONENT_TYPE__OWNED_ABSTRACT_FEATURE);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(Aadl2Package.Literals.COMPONENT_TYPE__OWNED_FLOW_SPECIFICATION,
				Aadl2Factory.eINSTANCE.createFlowSpecification()));

		newChildDescriptors.add(createChildParameter(Aadl2Package.Literals.COMPONENT_TYPE__OWNED_EXTENSION,
				Aadl2Factory.eINSTANCE.createTypeExtension()));

		newChildDescriptors.add(createChildParameter(Aadl2Package.Literals.COMPONENT_TYPE__OWNED_FEATURE_GROUP,
				Aadl2Factory.eINSTANCE.createFeatureGroup()));

		newChildDescriptors.add(createChildParameter(Aadl2Package.Literals.COMPONENT_TYPE__OWNED_ABSTRACT_FEATURE,
