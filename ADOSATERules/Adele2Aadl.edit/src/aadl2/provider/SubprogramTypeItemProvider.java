...
public class SubprogramTypeItemProvider extends ComponentTypeItemProvider {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(Aadl2Package.Literals.SUBPROGRAM_TYPE__OWNED_EVENT_DATA_PORT);
			childrenFeatures.add(Aadl2Package.Literals.SUBPROGRAM_TYPE__OWNED_EVENT_PORT);
			childrenFeatures.add(Aadl2Package.Literals.SUBPROGRAM_TYPE__OWNED_PARAMETER);
			childrenFeatures.add(Aadl2Package.Literals.SUBPROGRAM_TYPE__OWNED_DATA_ACCESS);
			childrenFeatures.add(Aadl2Package.Literals.SUBPROGRAM_TYPE__OWNED_SUBPROGRAM_ACCESS);
			childrenFeatures.add(Aadl2Package.Literals.SUBPROGRAM_TYPE__OWNED_SUBPROGRAM_GROUP_ACCESS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(Aadl2Package.Literals.SUBPROGRAM_TYPE__OWNED_EVENT_DATA_PORT,
				Aadl2Factory.eINSTANCE.createEventDataPort()));

		newChildDescriptors.add(createChildParameter(Aadl2Package.Literals.SUBPROGRAM_TYPE__OWNED_EVENT_PORT,
				Aadl2Factory.eINSTANCE.createEventPort()));

		newChildDescriptors.add(createChildParameter(Aadl2Package.Literals.SUBPROGRAM_TYPE__OWNED_PARAMETER,
				Aadl2Factory.eINSTANCE.createParameter()));

		newChildDescriptors.add(createChildParameter(Aadl2Package.Literals.SUBPROGRAM_TYPE__OWNED_DATA_ACCESS,
				Aadl2Factory.eINSTANCE.createDataAccess()));

		newChildDescriptors.add(createChildParameter(Aadl2Package.Literals.SUBPROGRAM_TYPE__OWNED_SUBPROGRAM_ACCESS,
				Aadl2Factory.eINSTANCE.createSubprogramAccess()));

		newChildDescriptors
				.add(createChildParameter(Aadl2Package.Literals.SUBPROGRAM_TYPE__OWNED_SUBPROGRAM_GROUP_ACCESS,
