...
public class FeatureGroupTypeItemProvider extends ClassifierItemProvider {
	...
	protected void addOwnedFeaturePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						Aadl2Package.Literals.FEATURE_GROUP_TYPE__OWNED_FEATURE, false, false, false, null, null,
						null));
	}
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_FeatureGroupType_extended_feature",
								"_UI_FeatureGroupType_type"),
						Aadl2Package.Literals.FEATURE_GROUP_TYPE__EXTENDED, true, false, true, null, null, null));
	}
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_FeatureGroupType_inverse_feature",
								"_UI_FeatureGroupType_type"),
						Aadl2Package.Literals.FEATURE_GROUP_TYPE__INVERSE, true, false, true, null, null, null));
	}
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(Aadl2Package.Literals.FEATURE_GROUP_TYPE__OWNED_EXTENSION);
			childrenFeatures.add(Aadl2Package.Literals.FEATURE_GROUP_TYPE__OWNED_BUS_ACCESS);
			childrenFeatures.add(Aadl2Package.Literals.FEATURE_GROUP_TYPE__OWNED_DATA_ACCESS);
			childrenFeatures.add(Aadl2Package.Literals.FEATURE_GROUP_TYPE__OWNED_DATA_PORT);
			childrenFeatures.add(Aadl2Package.Literals.FEATURE_GROUP_TYPE__OWNED_EVENT_DATA_PORT);
			childrenFeatures.add(Aadl2Package.Literals.FEATURE_GROUP_TYPE__OWNED_EVENT_PORT);
			childrenFeatures.add(Aadl2Package.Literals.FEATURE_GROUP_TYPE__OWNED_FEATURE_GROUP);
			childrenFeatures.add(Aadl2Package.Literals.FEATURE_GROUP_TYPE__OWNED_PARAMETER);
			childrenFeatures.add(Aadl2Package.Literals.FEATURE_GROUP_TYPE__OWNED_SUBPROGRAM_ACCESS);
			childrenFeatures.add(Aadl2Package.Literals.FEATURE_GROUP_TYPE__OWNED_SUBPROGRAM_GROUP_ACCESS);
			childrenFeatures.add(Aadl2Package.Literals.FEATURE_GROUP_TYPE__OWNED_ABSTRACT_FEATURE);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(Aadl2Package.Literals.FEATURE_GROUP_TYPE__OWNED_EXTENSION,
				Aadl2Factory.eINSTANCE.createGroupExtension()));

		newChildDescriptors.add(createChildParameter(Aadl2Package.Literals.FEATURE_GROUP_TYPE__OWNED_BUS_ACCESS,
				Aadl2Factory.eINSTANCE.createBusAccess()));

		newChildDescriptors.add(createChildParameter(Aadl2Package.Literals.FEATURE_GROUP_TYPE__OWNED_DATA_ACCESS,
				Aadl2Factory.eINSTANCE.createDataAccess()));

		newChildDescriptors.add(createChildParameter(Aadl2Package.Literals.FEATURE_GROUP_TYPE__OWNED_DATA_PORT,
				Aadl2Factory.eINSTANCE.createDataPort()));

		newChildDescriptors.add(createChildParameter(Aadl2Package.Literals.FEATURE_GROUP_TYPE__OWNED_EVENT_DATA_PORT,
				Aadl2Factory.eINSTANCE.createEventDataPort()));

		newChildDescriptors.add(createChildParameter(Aadl2Package.Literals.FEATURE_GROUP_TYPE__OWNED_EVENT_PORT,
				Aadl2Factory.eINSTANCE.createEventPort()));

		newChildDescriptors.add(createChildParameter(Aadl2Package.Literals.FEATURE_GROUP_TYPE__OWNED_FEATURE_GROUP,
				Aadl2Factory.eINSTANCE.createFeatureGroup()));

		newChildDescriptors.add(createChildParameter(Aadl2Package.Literals.FEATURE_GROUP_TYPE__OWNED_PARAMETER,
				Aadl2Factory.eINSTANCE.createParameter()));

		newChildDescriptors.add(createChildParameter(Aadl2Package.Literals.FEATURE_GROUP_TYPE__OWNED_SUBPROGRAM_ACCESS,
				Aadl2Factory.eINSTANCE.createSubprogramAccess()));

		newChildDescriptors
				.add(createChildParameter(Aadl2Package.Literals.FEATURE_GROUP_TYPE__OWNED_SUBPROGRAM_GROUP_ACCESS,
						Aadl2Factory.eINSTANCE.createSubprogramGroupAccess()));

		newChildDescriptors.add(createChildParameter(Aadl2Package.Literals.FEATURE_GROUP_TYPE__OWNED_ABSTRACT_FEATURE,
