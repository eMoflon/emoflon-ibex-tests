...
public class ConnectedElementItemProvider extends ElementItemProvider {
	...
	protected void addContextPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						Aadl2Package.Literals.CONNECTED_ELEMENT__CONTEXT, true, false, true, null, null, null));
	}
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_ConnectedElement_connectionEnd_feature",
								"_UI_ConnectedElement_type"),
						Aadl2Package.Literals.CONNECTED_ELEMENT__CONNECTION_END, true, false, true, null, null, null));
	}
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(Aadl2Package.Literals.CONNECTED_ELEMENT__NEXT);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(Aadl2Package.Literals.CONNECTED_ELEMENT__NEXT,
