...
/**
 * This is the item provider adapter for a {@link org.topcased.adele.model.KernelSpices.SKRelation} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SKRelationItemProvider
	 ...
	 * @generated
	 */
	public SKRelationItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_SKRelation_objects_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_SKRelation_objects_feature", "_UI_SKRelation_type"),
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/SKRelation"));
	}
	...
	public String getText(Object object) {
		String label = ((SKRelation)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_SKRelation_type") :
			getString("_UI_SKRelation_type") + " " + label;
	}
