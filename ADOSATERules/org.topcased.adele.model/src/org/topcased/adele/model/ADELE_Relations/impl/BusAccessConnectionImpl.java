...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>ADELE Bus Access Connection</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * </p>
 *
 * @generated
 */
public class BusAccessConnectionImpl extends AccessConnectionImpl implements BusAccessConnection {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected BusAccessConnectionImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return ADELE_RelationsPackage.Literals.BUS_ACCESS_CONNECTION;
	}
	...
	public boolean verify(String p_keyword) throws SKHierarchicalObjectException {
		if (p_keyword.equals("connections") || 
				...
				p_keyword.equals("bus access connections")) 
			return true;
		else
	...
	/**
	 * Test if the current element is an ADELE bus access connection
	 * @return boolean
	 * @generated NOT
	 */
	public boolean isBusAccessConnection(){
		return true;
	}
