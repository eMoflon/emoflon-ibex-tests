...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>ADELE Event Data Port Connection</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * </p>
 *
 * @generated
 */
public class EventDataPortConnectionImpl extends DirectedFeatureConnectionImpl implements EventDataPortConnection {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected EventDataPortConnectionImpl() {
		super();
	}
	...
	public boolean verify(String p_keyword) throws SKHierarchicalObjectException {
		if (p_keyword.equals("connections") || 
				...
				p_keyword.equals("event data port connections")) 
			return true;
		else
	...
	/**
	 * Test if the current element is an ADELE event data port connection
	 * @return boolean
	 * @generated NOT
	 */
	public boolean isEventDataPortConnection(){
		return true;
	}
...
} //ADELE_EventDataPortConnectionImpl