...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>ADELE Data Port Connection</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * </p>
 *
 * @generated
 */
public class DataPortConnectionImpl extends DirectedFeatureConnectionImpl implements DataPortConnection {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected DataPortConnectionImpl() {
		super();
	}
	...
	public boolean verify(String p_keyword) throws SKHierarchicalObjectException {
		if (p_keyword.equals("connections") || 
				...
				p_keyword.equals("data port connections")) 
			return true;
		else
	...
	/**
	 * Test if the current element is an ADELE data port connection
	 * @return boolean
	 * @generated NOT
	 */
	public boolean isDataPortConnection(){
		return true;
	}
