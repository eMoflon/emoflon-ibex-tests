...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>ADELE Parameter</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * </p>
 *
...
public class ParameterImpl extends DirectedFeatureImpl implements Parameter {
	...
	/**
	 * Test if the current element is an ADELE parameter
	 * @return boolean
	 * @generated NOT
	 */
...
//		}
//		
//		aadl+="isFeature('PARAMETER','"+ packageName+"','"+componentIdentifier+"','"+name+"','"+directionFact+"','NIL','"+
