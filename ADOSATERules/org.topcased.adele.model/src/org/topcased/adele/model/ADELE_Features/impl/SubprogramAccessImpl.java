...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>ADELE Subprogram Access</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * </p>
 *
...
public class SubprogramAccessImpl extends AccessImpl implements SubprogramAccess {
	...
	public boolean verify(String p_keyword) throws SKHierarchicalObjectException {
		if (p_keyword.equals("subprogram access")) 
			return true;
		else
	...
	/**
	 * Test if the current element is an ADELE subprogram access
	 * @return boolean
	 * @generated NOT
	 */
	public boolean isSubprogramAccess(){
		return true;
	}
//
...
//		}
//		
//		aadl+="isFeature('ACCESS','"+ packageName+"','"+componentIdentifier+"','"+name+"','"+directionFact+"','SUBPROGRAM','"+
