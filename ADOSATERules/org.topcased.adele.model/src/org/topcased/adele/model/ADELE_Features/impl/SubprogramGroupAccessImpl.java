...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>ADELE Subprogram Group Access</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * </p>
 *
...
public class SubprogramGroupAccessImpl extends AccessImpl implements SubprogramGroupAccess {
	...
	public boolean verify(String p_keyword) throws SKHierarchicalObjectException {
		if (p_keyword.equals("subprogram group access")) 
			return true;
		else
	...
	/**
	 * Test if the current element is an ADELE subprogram group access
	 * @return boolean
	 * @generated NOT
	 */
	public boolean isSubprogramGroupAccess(){
		return true;
	}
//
...
//		}
//		
//		aadl+="isFeature('ACCESS','"+ packageName+"','"+componentIdentifier+"','"+name+"','"+directionFact+"','SUBPROGRAM GROUP','"+
...
} //ADELE_SubprogramGroupAccessImpl
