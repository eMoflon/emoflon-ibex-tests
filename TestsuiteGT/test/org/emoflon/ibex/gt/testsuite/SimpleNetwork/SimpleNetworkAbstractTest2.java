...
public class SimpleNetworkAbstractTest2
		extends GTAppTestCase<SimpleNetworkGraphTransformation2App, SimpleNetworkGraphTransformation2API> {
	...
	protected SimpleNetworkGraphTransformation2App getApp() {
		...
		if (interpreter instanceof HiPEGTEngine) {
