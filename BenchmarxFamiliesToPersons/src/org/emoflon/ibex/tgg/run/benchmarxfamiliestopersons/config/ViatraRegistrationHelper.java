...
public class ViatraRegistrationHelper implements IRegistrationHelper {
	...
	public void registerMetamodels(ResourceSet rs, IbexExecutable executable) throws IOException {
		...
		executable.getResourceHandler().loadAndRegisterMetamodel("platform:/resource/Families/model/Families.ecore");
		executable.getResourceHandler().loadAndRegisterMetamodel("platform:/resource/Persons/model/Persons.ecore");
	}
