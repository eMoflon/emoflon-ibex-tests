package org.emoflon.ibex.tgg.run.familywithsiblingstopersons_ma.debug;
...
import org.emoflon.ibex.tgg.run.familywithsiblingstopersons_ma.MODELGEN_App;

public class MODELGEN_Debug_App extends MODELGEN_App {

	public MODELGEN_Debug_App() throws IOException {
		super("FamilyWithSiblingsToPersons_MA", "./../", true);
	}
