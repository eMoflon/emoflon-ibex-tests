...
public class AlgorithmsPackageImpl extends EPackageImpl implements AlgorithmsPackage {
	...
	public static AlgorithmsPackage init() {
		...
		AlgorithmsPackageImpl theAlgorithmsPackage = (AlgorithmsPackageImpl) (EPackage.Registry.INSTANCE
				.get(eNS_URI) instanceof AlgorithmsPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI)
	...
	public void initializePackageContents() {
		...
		initEClass(algorithmContainerEClass, AlgorithmContainer.class, "AlgorithmContainer", !IS_ABSTRACT,
				!IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getAlgorithmContainer_Algorithms(), this.getAlgorithm(), null, "algorithms", null, 0, -1,
				AlgorithmContainer.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getAlgorithmContainer_Name(), ecorePackage.getEString(), "name", null, 1, 1,
				AlgorithmContainer.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, !IS_ORDERED);

		initEClass(algorithmEClass, Algorithm.class, "Algorithm", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getAlgorithm_Name(), ecorePackage.getEString(), "name", null, 1, 1, Algorithm.class,
