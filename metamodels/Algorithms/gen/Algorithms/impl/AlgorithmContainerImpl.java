 ...
 * @generated
 */
public class AlgorithmContainerImpl extends EObjectImpl implements AlgorithmContainer {
	/**
	...
	public EList<Algorithm> getAlgorithms() {
		if (algorithms == null) {
			algorithms = new EObjectContainmentEList<Algorithm>(Algorithm.class, this,
					AlgorithmsPackage.ALGORITHM_CONTAINER__ALGORITHMS);
		}
		return algorithms;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AlgorithmsPackage.ALGORITHM_CONTAINER__NAME, oldName,
					name));
	}
