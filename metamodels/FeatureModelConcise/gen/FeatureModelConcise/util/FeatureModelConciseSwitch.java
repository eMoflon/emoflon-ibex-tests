 ...
 * @generated
 */
public class FeatureModelConciseSwitch<T> extends Switch<T> {
	/**
	 ...
	 * @generated
	 */
	public FeatureModelConciseSwitch() {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
		case FeatureModelConcisePackage.NAMED_ELEMENT: {
		...
		case FeatureModelConcisePackage.GROUP: {
