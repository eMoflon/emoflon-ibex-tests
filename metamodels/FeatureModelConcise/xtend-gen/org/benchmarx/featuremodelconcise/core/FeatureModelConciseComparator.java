...
import org.benchmarx.featuremodelconcise.core.GroupNormaliser;
...
public class FeatureModelConciseComparator implements Comparator<Model> {
  ...
  public void assertEquals(final Model expected, final Model actual) {
    ...
    boolean _startsWith = _stringify.startsWith("FeatureModelConcise");
  ...
  public String stringify(final Feature feature) {
    ...
    _builder.newLine();
    {
      ...
      ArrayList<Feature> _normalise_1 = this.featureNormaliser.normalise(_subfeatures);
