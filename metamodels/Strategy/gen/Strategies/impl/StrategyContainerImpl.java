 ...
 * @generated
 */
public class StrategyContainerImpl extends MinimalEObjectImpl.Container implements StrategyContainer {
	/**
	...
	public EList<Strategy> getStrategies() {
		if (strategies == null) {
			strategies = new EObjectContainmentEList<Strategy>(Strategy.class, this, StrategiesPackage.STRATEGY_CONTAINER__STRATEGIES);
		}
		return strategies;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, StrategiesPackage.STRATEGY_CONTAINER__NAME, oldName, name));
	}
