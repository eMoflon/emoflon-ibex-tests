...
import classMultipleInheritanceHierarchy.NamedElement;
 ...
 * @generated
 */
public class ClassMultipleInheritanceHierarchyPackageImpl extends EPackageImpl
		implements ClassMultipleInheritanceHierarchyPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see classMultipleInheritanceHierarchy.ClassMultipleInheritanceHierarchyPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private ClassMultipleInheritanceHierarchyPackageImpl() {
		super(eNS_URI, ClassMultipleInheritanceHierarchyFactory.eINSTANCE);
	}
	 ...
	 * 
	 * <p>This method is used to initialize {@link ClassMultipleInheritanceHierarchyPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static ClassMultipleInheritanceHierarchyPackage init() {
		if (isInited)
			return (ClassMultipleInheritanceHierarchyPackage) EPackage.Registry.INSTANCE
					.getEPackage(ClassMultipleInheritanceHierarchyPackage.eNS_URI);

		// Obtain or create and register package
		ClassMultipleInheritanceHierarchyPackageImpl theClassMultipleInheritanceHierarchyPackage = (ClassMultipleInheritanceHierarchyPackageImpl) (EPackage.Registry.INSTANCE
				.get(eNS_URI) instanceof ClassMultipleInheritanceHierarchyPackageImpl
						? EPackage.Registry.INSTANCE.get(eNS_URI)
						: new ClassMultipleInheritanceHierarchyPackageImpl());

		isInited = true;

		// Create package meta-data objects
		theClassMultipleInheritanceHierarchyPackage.createPackageContents();

		// Initialize created meta-data
		theClassMultipleInheritanceHierarchyPackage.initializePackageContents();

		// Mark meta-data to indicate it can't be changed
		theClassMultipleInheritanceHierarchyPackage.freeze();

		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(ClassMultipleInheritanceHierarchyPackage.eNS_URI,
				theClassMultipleInheritanceHierarchyPackage);
		return theClassMultipleInheritanceHierarchyPackage;
	}
	 ...
	 * @generated
	 */
	public ClassMultipleInheritanceHierarchyFactory getClassMultipleInheritanceHierarchyFactory() {
		return (ClassMultipleInheritanceHierarchyFactory) getEFactoryInstance();
	}
...
} //ClassMultipleInheritanceHierarchyPackageImpl
