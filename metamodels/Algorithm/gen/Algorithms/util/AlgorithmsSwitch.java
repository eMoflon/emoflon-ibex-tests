...
public class AlgorithmsSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case AlgorithmsPackage.ALGORITHM_CONTAINER: {
				AlgorithmContainer algorithmContainer = (AlgorithmContainer)theEObject;
				T result = caseAlgorithmContainer(algorithmContainer);
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Algorithm Container</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Algorithm Container</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseAlgorithmContainer(AlgorithmContainer object) {
		return null;
	}
