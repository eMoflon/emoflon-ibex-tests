...
public class AlgorithmsAdapterFactory extends AdapterFactoryImpl {
	...
	protected AlgorithmsSwitch<Adapter> modelSwitch =
		new AlgorithmsSwitch<Adapter>() {
			@Override
			public Adapter caseAlgorithmContainer(AlgorithmContainer object) {
				return createAlgorithmContainerAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link Algorithms.AlgorithmContainer <em>Algorithm Container</em>}'.
	 * <!-- begin-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createAlgorithmContainerAdapter() {
		return null;
	}

	/**
	 * Creates a new adapter for an object of class '{@link Algorithms.Algorithm <em>Algorithm</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
