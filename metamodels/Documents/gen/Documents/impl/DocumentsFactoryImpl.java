...
public class DocumentsFactoryImpl extends EFactoryImpl implements DocumentsFactory {
	...
	public static DocumentsFactory init() {
		try {
			DocumentsFactory theDocumentsFactory = (DocumentsFactory) EPackage.Registry.INSTANCE
					.getEFactory(DocumentsPackage.eNS_URI);
	 ...
	 * @generated
	 */
	public Documents.Container createContainer() {
