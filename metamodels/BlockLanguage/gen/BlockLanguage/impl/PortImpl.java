 ...
 * <ul>
 *   <li>{@link BlockLanguage.impl.PortImpl#getWire <em>Wire</em>}</li>
 *   <li>{@link BlockLanguage.impl.PortImpl#getId <em>Id</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class PortImpl extends EObjectImpl implements Port {
	...
	protected EClass eStaticClass() {
		return BlockLanguagePackage.Literals.PORT;
	}
	...
	public EList<Wire> getWire() {
		if (wire == null) {
			wire = new EObjectContainmentEList<Wire>(Wire.class, this, BlockLanguagePackage.PORT__WIRE);
		}
		return wire;
	}
	...
	public void setId(int newId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BlockLanguagePackage.PORT__ID, oldId, id));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case BlockLanguagePackage.PORT__WIRE:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		...
		case BlockLanguagePackage.PORT__WIRE:
			return getWire();
		case BlockLanguagePackage.PORT__ID:
			return getId();
		}
