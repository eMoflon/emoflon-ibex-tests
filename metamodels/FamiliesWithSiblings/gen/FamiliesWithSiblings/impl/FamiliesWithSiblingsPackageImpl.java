 ...
 * @generated
 */
public class FamiliesWithSiblingsPackageImpl extends EPackageImpl implements FamiliesWithSiblingsPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see FamiliesWithSiblings.FamiliesWithSiblingsPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private FamiliesWithSiblingsPackageImpl() {
		super(eNS_URI, FamiliesWithSiblingsFactory.eINSTANCE);
	}
	 ...
	 * 
	 * <p>This method is used to initialize {@link FamiliesWithSiblingsPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static FamiliesWithSiblingsPackage init() {
		if (isInited)
			return (FamiliesWithSiblingsPackage) EPackage.Registry.INSTANCE
					.getEPackage(FamiliesWithSiblingsPackage.eNS_URI);

		// Obtain or create and register package
		FamiliesWithSiblingsPackageImpl theFamiliesWithSiblingsPackage = (FamiliesWithSiblingsPackageImpl) (EPackage.Registry.INSTANCE
				.get(eNS_URI) instanceof FamiliesWithSiblingsPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI)
						: new FamiliesWithSiblingsPackageImpl());

		isInited = true;

		// Create package meta-data objects
		theFamiliesWithSiblingsPackage.createPackageContents();

		// Initialize created meta-data
		theFamiliesWithSiblingsPackage.initializePackageContents();

		// Mark meta-data to indicate it can't be changed
		theFamiliesWithSiblingsPackage.freeze();

		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(FamiliesWithSiblingsPackage.eNS_URI, theFamiliesWithSiblingsPackage);
		return theFamiliesWithSiblingsPackage;
	}
	 ...
	 * @generated
	 */
	public EReference getFamily_Siblings() {
	 ...
	 * @generated
	 */
	public FamiliesWithSiblingsFactory getFamiliesWithSiblingsFactory() {
		return (FamiliesWithSiblingsFactory) getEFactoryInstance();
	}
	...
	public void createPackageContents() {
		...
		createEReference(familyEClass, FAMILY__SIBLINGS);
	...
	public void initializePackageContents() {
		...
		initEReference(getFamily_FamiliesInverse(), this.getFamilyRegister(), this.getFamilyRegister_Families(),
				...
				!IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getFamily_Siblings(), this.getFamily(), null, "siblings", null, 0, 5, Family.class,
...
} //FamiliesWithSiblingsPackageImpl
