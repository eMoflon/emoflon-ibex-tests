 ...
 * @generated
 */
public class FeatureModelSafeSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
		case FeatureModelSafePackage.NAMED_ELEMENT: {
		...
		case FeatureModelSafePackage.GROUP: {
