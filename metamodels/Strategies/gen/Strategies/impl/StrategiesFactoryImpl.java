...
public class StrategiesFactoryImpl extends EFactoryImpl implements StrategiesFactory {
	...
	public static StrategiesFactory init() {
		try {
			StrategiesFactory theStrategiesFactory = (StrategiesFactory) EPackage.Registry.INSTANCE
					.getEFactory(StrategiesPackage.eNS_URI);
	...
	public EObject create(EClass eClass) {
		...
		case StrategiesPackage.STRATEGY_CONTAINER:
			return createStrategyContainer();
