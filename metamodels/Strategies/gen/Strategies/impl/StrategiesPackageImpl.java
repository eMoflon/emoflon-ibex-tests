...
public class StrategiesPackageImpl extends EPackageImpl implements StrategiesPackage {
	...
	public static StrategiesPackage init() {
		if (isInited)
			return (StrategiesPackage) EPackage.Registry.INSTANCE.getEPackage(StrategiesPackage.eNS_URI);

		// Obtain or create and register package
		StrategiesPackageImpl theStrategiesPackage = (StrategiesPackageImpl) (EPackage.Registry.INSTANCE
				.get(eNS_URI) instanceof StrategiesPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI)
						: new StrategiesPackageImpl());
	...
	public void initializePackageContents() {
		...
		initEClass(strategyContainerEClass, StrategyContainer.class, "StrategyContainer", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(getStrategyContainer_Strategies(), this.getStrategy(), null, "strategies", null, 0, -1,
				StrategyContainer.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getStrategyContainer_Name(), ecorePackage.getEString(), "name", null, 1, 1,
				StrategyContainer.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, !IS_ORDERED);

		initEClass(strategyEClass, Strategy.class, "Strategy", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getStrategy_Name(), ecorePackage.getEString(), "name", null, 1, 1, Strategy.class, !IS_TRANSIENT,
