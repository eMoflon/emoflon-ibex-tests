...
import org.emoflon.ibex.tgg.run.familywithsiblingstopersons_ma.CO_App;
...
public class CO_App extends CO {
	...
	public static void main(String[] args) throws IOException {
		...
		CO_App co = new CO_App("FamiliesWithSiblingsToPersons_MA", "./../", true, "/resources/co/src", "/resources/co/trg", 
