 ...
 * @generated
 */
public class ExtTypeModelPackageImpl extends EPackageImpl implements ExtTypeModelPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see ExtTypeModel.ExtTypeModelPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private ExtTypeModelPackageImpl() {
		super(eNS_URI, ExtTypeModelFactory.eINSTANCE);
	}
	 ...
	 *
	 * <p>This method is used to initialize {@link ExtTypeModelPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static ExtTypeModelPackage init() {
		if (isInited)
			return (ExtTypeModelPackage) EPackage.Registry.INSTANCE.getEPackage(ExtTypeModelPackage.eNS_URI);

		// Obtain or create and register package
		Object registeredExtTypeModelPackage = EPackage.Registry.INSTANCE.get(eNS_URI);
		ExtTypeModelPackageImpl theExtTypeModelPackage = registeredExtTypeModelPackage instanceof ExtTypeModelPackageImpl
				? (ExtTypeModelPackageImpl) registeredExtTypeModelPackage
				: new ExtTypeModelPackageImpl();

		isInited = true;

		// Create package meta-data objects
		theExtTypeModelPackage.createPackageContents();

		// Initialize created meta-data
		theExtTypeModelPackage.initializePackageContents();

		// Mark meta-data to indicate it can't be changed
		theExtTypeModelPackage.freeze();

		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(ExtTypeModelPackage.eNS_URI, theExtTypeModelPackage);
		return theExtTypeModelPackage;
	}
	 ...
	 */
	@Override
	public EAttribute getPackage_FQname() {
	 ...
	 */
	@Override
	public EReference getType_ExtendedBy() {
	 ...
	 */
	@Override
	public EReference getType_InheritsFrom() {
	 ...
	 */
	@Override
	public EAttribute getJavaDoc_Comment() {
	 ...
	 */
	@Override
	public EReference getJavaDoc_Method() {
		return (EReference) javaDocEClass.getEStructuralFeatures().get(1);
	}
	...
	public void createPackageContents() {
		...
		createEReference(typeEClass, TYPE__EXTENDED_BY);
		createEReference(typeEClass, TYPE__INHERITS_FROM);
