 ...
 * @generated
 */
public class ExtTypeModelSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
		case ExtTypeModelPackage.NAMED_ELEMENT: {
		...
		case ExtTypeModelPackage.PACKAGE: {
			ExtTypeModel.Package package_ = (ExtTypeModel.Package) theEObject;
	 ...
	 * @generated
	 */
	public T casePackage(ExtTypeModel.Package object) {
		return null;
	}
