...
import SlowSimpleGraphTransformation.api.SlowSimpleGraphTransformationAPI;
import SlowSimpleGraphTransformation.api.SlowSimpleGraphTransformationApp;
import SlowSimpleGraphTransformation.api.SlowSimpleGraphTransformationDemoclesApp;
import SlowSimpleGraphTransformation.api.SlowSimpleGraphTransformationHiPEApp;
import performanceTests.GTPerformanceTest;

public class SlowSimpleAttributeTest extends GTPerformanceTest {


	@Override
	protected String getTestName() {
		return "SlowSimpleAttributeTest";
	}
	...
	protected void prepare(int[] modelSizes) {
		for (int modelSize : modelSizes) {
			SlowSimpleGraphTransformationApp app = new SlowSimpleGraphTransformationHiPEApp(WORKSPACE_PATH);
			app.createModel(createURI(modelSize));
			SlowSimpleGraphTransformationAPI api = app.initAPI();
...
//		SlowSimpleGraphTransformationApp app = new SlowSimpleGraphTransformationHiPEApp(WORKSPACE_PATH);
		SlowSimpleGraphTransformationApp app = new SlowSimpleGraphTransformationDemoclesApp(WORKSPACE_PATH);
		// Initialization.
