...
public class SYNC_ON_1 extends SYNC {
	...
	public SYNC_ON_1() throws IOException {
	...
	public static void main(String[] args) throws IOException {
		...
		System.out.println("ON_ANFANG");

		SYNC_ON_1 sync = new SYNC_ON_1();
		...
		helperH.changeRoof(root, 2, true);
		sync.forward();
		...
		System.out.println(sync.getOptions().debug.benchmarkLogger().getInitTime());
	}
