...
public class TerraceHousesHelper {
	...
	public House createHouse(Structure structureBefore, String name, String address, boolean pitchedRoof) {
		return createHouse(structureBefore, name, address, pitchedRoof, false);
	}
	...
	public House createHouse(Structure structureBefore, String name, String address, boolean pitchedRoof,
		...
		newHouse.setPrefab(prefab);
		structureBefore.setNext(newHouse);
		return newHouse;
	}

	public Skyway createSkyway(House entry, House exit, String name) {
		Skyway newSkyway = TerraceHousesFactory.eINSTANCE.createSkyway();
		newSkyway.setName(name);
		entry.setSkywayEntry(newSkyway);
		newSkyway.setExit(exit);
		return newSkyway;
	}
