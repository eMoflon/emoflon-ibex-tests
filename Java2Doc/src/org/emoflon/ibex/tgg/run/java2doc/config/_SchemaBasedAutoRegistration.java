...
public class _SchemaBasedAutoRegistration {
	...
	public static void register(OperationalStrategy strategy) throws IOException {
		strategy.loadAndRegisterMetamodel("platform:/resource/SimpleJava/model/simpleJava.ecore");
		strategy.loadAndRegisterMetamodel("platform:/resource/SimpleDoc/model/simpleDoc.ecore");
	}
