...
public class CO_App extends CO {
	...
	public CO_App(String projectName, String workspacePath, boolean debug, String srcPath, String trgPath, 
		...
		super(registrationHelper.createIbexOptions().projectName(projectName).workspacePath(workspacePath).debug(debug).setResourceHandler(new CO_TGGResourceHandler()));
	...
	public static void main(String[] args) throws IOException {
		...
		CO_App co = new CO_App("FamiliesToPersons_V0", "./../", true, "/resources/co/src", "/resources/co/trg", 
