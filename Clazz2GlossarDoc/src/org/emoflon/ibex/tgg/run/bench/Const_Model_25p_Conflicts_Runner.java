...
public class Const_Model_25p_Conflicts_Runner {

	private static int[] ns = { //
			100 //100, 200, 300, 500, 1000, 1500, 2000, 2500, 3000, 3500, 4000, 4500, 5000 //
	};
		...
		for (int i = 0; i < ns.length; i++) {
			for (int j = 0; j < cs.length; j++) {
				for (int r = 0; r < repetitions; r++) {
					Process proc = exec(Horizontal_IntegrationBench.class, Arrays.asList("-Xmx120G"), Arrays.asList("" + ns[i], "" + cs[j], "t:t:f:f"));
					proc.waitFor();
					proc.exitValue();
