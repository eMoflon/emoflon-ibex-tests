...
/**
 * This is the item provider adapter for a {@link org.emoflon.express.express.EnumerationValue} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class EnumerationValueItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_EnumerationValue_name_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_EnumerationValue_name_feature", "_UI_EnumerationValue_type"),
				 ExpressPackage.Literals.ENUMERATION_VALUE__NAME,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((EnumerationValue)object).getName();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(EnumerationValue.class)) {
			case ExpressPackage.ENUMERATION_VALUE__NAME:
