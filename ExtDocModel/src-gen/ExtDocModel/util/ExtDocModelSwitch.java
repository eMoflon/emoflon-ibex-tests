 ...
 * @generated
 */
public class ExtDocModelSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
		case ExtDocModelPackage.NAMED_ELEMENT: {
		...
		case ExtDocModelPackage.FOLDER: {
			...
			if (result == null)
				result = caseNamedElement(folder);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		...
		case ExtDocModelPackage.GLOSSARY_ENTRY: {
			...
			if (result == null)
				result = caseNamedElement(glossaryEntry);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case ExtDocModelPackage.DOC_CONTAINER: {
			DocContainer docContainer = (DocContainer) theEObject;
			T result = caseDocContainer(docContainer);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Doc Container</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Doc Container</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseDocContainer(DocContainer object) {
		return null;
	}
